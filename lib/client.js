...
(function() {
  ...
  module.exports = (function(_super) {
    ...
    exports.prototype.on_open_moncompte = function() {
      ...
      this.inject('get_connected_url', function(url) {
        return debug('connected url', url);
      });
      this.inject('get_ident_div', function(obj) {
        return debug('ident_div', obj != null);
      });
      return this.inject('enter_credentials', this.options.login, this.options.password, function(result) {
        return debug('credentials entered', result);
      });
    };
